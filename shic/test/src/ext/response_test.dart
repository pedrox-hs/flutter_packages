...
void main() {
  group('ResponseExt', () {
    test('bodyJson should parse json correctly', () {
      // arrange
  ...
  group('StreamedResponseExt', () {
    test('body should return body as string', () async {
      ...
      final response = StreamedResponse(Stream.value(expected.codeUnits), 200);
    ...
    test('bodyJson should parse json correctly', () async {
      // arrange
      final expected = {'foo': 'bar'};
  ...
  group('FutureResponseExt', () {
    test('mapJsonWith should map json correctly', () async {
      // arrange
