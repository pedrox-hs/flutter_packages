...
void main() {
  group('RequestExt', () {
    ...
    test(
      'should copy multipart request',
      () {
        // arrange
        final request =
            MultipartRequest('POST', Uri.parse('https://example.com'))
              ..fields['foo'] = 'bar';
    ...
    test(
      'should copy streamed request',
      () {
        // arrange
        final request =
            StreamedRequest('POST', Uri.parse('https://example.com'));
    ...
    test(
      'should throw UnsupportedError if request type is not supported',
      () {
        // arrange
