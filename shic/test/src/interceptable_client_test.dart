...
void main() {
  group(InterceptableClient, () {
    test(
      'should create client with interceptor',
      () {
        // arrange
    ...
    group('withDefaultInterceptors', () {
      test(
        'should add default interceptors',
        () {
          // arrange
      ...
      test(
        'should add default interceptors when baseUrl is provided',
        () {
          // arrange
          final client = InterceptableClient.withDefaultInterceptors(
    ...
    group('send', () {
      ...
      test(
        'should dispatch request to interceptors in order',
        () async {
          // arrange
      ...
      test(
        ...
        () async {
          ...
          final request = Request('GET', Uri.parse('https://example.com'));
          final response = StreamedResponse(Stream.empty(), 200);
          when(() => mockInterceptors.first.intercept(any(), any()))
