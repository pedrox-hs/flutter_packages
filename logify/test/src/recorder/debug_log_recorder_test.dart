...
void main() {
  group(DebugLogRecorder, () {
    ...
    setUp(() {
      ...
      sut = DebugLogRecorder(stdout: stdout, stderr: stderr);
    ...
    test('should print not spaced location when hasTerminal returns false', () {
      // arrange
      final record = LogRecord(Level.INFO, 'some info message', 'logger_name');
